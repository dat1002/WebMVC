                           ...
                           <li>
                              <c:choose>
                                    <c:when test = "${isLogined}">
                                      <div class="dropdown">
                                        <button class="dropdown-toggle" style="padding: 0; border: none; background-color: #F9F5FA !important;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="head-bot d-block bg-white" style="width: 100%;">
                <div class="container d-flex justify-content-between bg-white">
                    <div class="shop-name text-center pt-2" style="letter-spacing: 4px;">
                        <a href="${base}/index" class="text-dark text-decoration-none">
                    ...
                    <div class="main-menu d-lg-block">
                        <ul class="nav" id="apper">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "  href="${base}/category/${category.seo}" style="text-transform: uppercase;">${category.name}</a>
                                            ...
                                            <c:forEach items="${productList.data}" var="product">
                                                <c:if test="${product.getCategories().getId() == category.id}">
                                                    <a  href="${base }/details/${product.seo}">
                                                        <img src="${base}/upload/${product.avatar}" width="90px">
                                                        <h6 >${product.title}</h6>
                                                    </a>
                                                </c:if>
                                            </c:forEach>
                    ...
                    <div class="form_search position-relative pt-2">
                          <form id="list-product" action="${base}/search" method="get">
                            <input type="text" id="keyword" name="keyword" placeholder="Tìm kiếm ..." value="${searchModel.keyword }">
                            <button type="submit" value="Search" class="position-absolute">
