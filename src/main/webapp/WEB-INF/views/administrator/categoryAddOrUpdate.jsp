        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="${base}/admin/category/addOrUpdate" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content d-block" style="width: 100%;">
     <div class="m-auto" style="width: 70%;">
        <sf:form class="p-2 form-add-product" id="category" name="category" action="${base}/admin/category/addOrUpdate" method="post" modelAttribute="category" enctype="multipart/form-data" style="border-radius: 5px; border: solid 1px #ccc; width: 100%;">
          <!-- Xác định là thêm mới hay chỉnh sửa -->
          <sf:hidden path="id"/>
          <h1 class="mt-3" style="text-align: center; font-weight: 500; color: rgb(100, 87, 87);">Add/Update Category</h1>
            <div class="form-add-update-product">
              <div class="form-group">
                <label for="">Category Name</label><br>
                <sf:input type="text" id="name" name="name" path="name" Placeholder=" Category name"></sf:input>
              </div>

              <div class="form-group">
                <label for="">Description</label><br>
                <sf:textarea autocomplete="off" rows="4" id="description" name="description" path="description" Placeholder=" Description"></sf:textarea>
              </div>

            </div>
         <div class="form-group">
            <a href="#list-product" class="btn btn-secondary active" role="button" aria-pressed="true">Back to list</a>
           <a href="/admin/category/addOrUpdate" class="btn btn-danger">Add New Category</a>
      ...
      <div class="list-product mt-5" id="" style="width: 100%;">
        ...
        <form class="form-inline" id="list-product" action="${base }/admin/category/addOrUpdate" method="get">
        ...
        <form id="" name="" action="${base}/admin/category/addOrUpdate" method="GET" modelAttribute="category">
                  <table class=" mb-5" id="table-product">
                    ...
                    <c:forEach items="${categoryWithPaging.data}" var="category" varStatus="loop">
                      <tr>
                        <td><data class="categoryId" value="${category.id}">${category.id}</data></td>
                        <td>${category.name}</td>
                        <td>${category.description}</td>
                        <td>
                          <a class="btn btn-primary" href="/admin/category/edit/${category.id}"><i class="far fa-edit"></i></a>
                          <a href="/admin/category/delete/${category.id}" class="btn btn-danger delete-category" ><i class="fas fa-trash-alt"></i></a>
                          </td>
                      </tr>
                    </c:forEach>
                  </table>
